...
const SubscriptionMessage = styled.div`
  color: ${({ isSubscribed }) => (isSubscribed ? '#3399FF' : 'red')};
  margin-top: 8px;
`;
    ...
    <FooterContainer>
      <FooterSubscription>
        <FooterSubscriptionHeading>
          Cadastre-se para saber sobre promoções!
        </FooterSubscriptionHeading>
      ...
      <FooterLinks>
        <FooterLinkWrapper>
          <FooterLinkItems>
            <FooterLink to='/consultas'>Consultas</FooterLink>
      ...
      <SocialMedia>
        <SocialMediaWrap>
          ...
          <WebsiteRights> TechHealth © 2023</WebsiteRights>
          <SocialIcons>
